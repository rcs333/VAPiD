...
1. Download the all_virus.fasta reference database over on the release tab, (https://github.com/rcs333/VAPiD/releases/edit/v1.0). Download the .nhr .nsq and .nin file and place them in the VAPiD folder
