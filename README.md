...
RSV, Parainfluenzas, Metapneumovirus, Coronaviruses, Enterovirus/Rhinoviruses, Hepatitis A-E, Nipah, Sendai, Measles, Mumps, Ebola, Rotavirus, West Nile Virus, HTLV, HIV, Norovirus, JC, BK virus.
# Installation
...
1. Download MAFFT https://mafft.cbrc.jp/alignment/software/ for your appropriate system. (THIS IS ALREADY DONE FOR WINDOWS and is included under the GPL licence) Make sure you select the all-in-one version. (Mac and Linux) Unzip the folder and place all files in the folder where this repository is living.
...
**Example Usage (with blast+ and a local blast database installed)**
